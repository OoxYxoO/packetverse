...
import { VPLS_BRIEFING_NOTES, VPLS_BRIEFING_PHASES } from "./briefing";
import { VPLS_LESSON_SECTIONS, VplsLessonGuideContent } from "./LessonGuideContent";
import { VPLS_DEEP_DIVE_SECTIONS, VplsDeepDiveContent } from "./DeepDiveContent";

const GUIDE_TABS: LessonGuideTab[] = [
  { id: "lesson", label: "This Lesson", hint: "PE1 · PE2 · PE3 full mesh · CUST-A-VPLS", sections: VPLS_LESSON_SECTIONS, content: <VplsLessonGuideContent /> },
  { id: "deep", label: "VPLS Deep Dive", hint: "Traditional VPLS in general", sections: VPLS_DEEP_DIVE_SECTIONS, content: <VplsDeepDiveContent /> },
];
...
export default function MplsVplsDemo() {
  ...
  const briefing = currentStep ? resolveBriefing(currentStep.id, currentStep.label, VPLS_BRIEFING_PHASES, VPLS_BRIEFING_NOTES) : undefined;
  ...
  return (
    <div className="mx-auto max-w-7xl px-6 py-10">
      ...
      <div>
        ...
        <LessonGuideDialog open={guideOpen} onClose={() => setGuideOpen(false)} title="Traditional MPLS VPLS" subtitle="CUST-A-VPLS · VPLS-500 · 3 PEs, 3 PWs" tabs={GUIDE_TABS} />
      </div>
