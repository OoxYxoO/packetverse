...
export default function Srv6EndpointBehaviorsDemo() {
  ...
  function explorerTabsFor(router: RouterId): DeviceExplorerTab[] {
    ...
    if (router === "R3") return [overviewTab, hardwareTab, interfacesTab, fibTab, locatorTab, localSidTab, behaviorTabFor(FUNCTION.END, "End"), behaviorTabFor(FUNCTION.END_X, "End.X"), behaviorTabFor(FUNCTION.END_T, "End.T"), packetTab, cliTab];
    if (router === "R6") {
      ...
      return [overviewTab, hardwareTab, interfacesTab, fibTab, locatorTab, localSidTab, serviceBehaviorsTab, vrf4Tab, vrf6Tab, l3AdjTab, l2XcTab, packetTab, cliTab];
    }
  ...
  useEffect(() => {
    if (isComplete) {
      completeLesson("srv6-endpoint-behaviors", 700);
