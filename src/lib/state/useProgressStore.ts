...
export const ACHIEVEMENTS: Achievement[] = [
  ...
  { id: "srv6-resilience-engineer", title: "SRv6 Resilience Engineer", description: "Precomputed a TI-LFA repair path from real P-Space/extended P-Space/Q-Space analysis, activated local repair at the PLR instantly on failure detection, proved a naive redirect genuinely loops from real stale-FIB state, protected both a link and a node with a globally-routed End.X+USD SID, and repaired a wrong precomputed repair list without waiting for convergence." },
  { id: "srv6-compression-engineer", title: "SRv6 Compression Engineer", description: "Built RFC 9800 NEXT-CSID and REPLACE-CSID compression from validated SID structures, proved an intra-container shift never decrements Segments Left while a container-boundary crossing always does, forced an End.X adjacency across a compressed container boundary, ended a REPLACE-CSID run in a real End.DT4 SID, and repaired a broken structure advertisement twice without ever collapsing partial compression to all-or-nothing." },
  { id: "segment-routing-architect", title: "Segment Routing Architect", description: "Solved the identical engineering brief — shortest-path transport, explicit TE, a CUST-A L3VPN, and local FRR — once in SR-MPLS and once in SRv6 from the same shared topology and the same TI-LFA computation, diagnosed a missing SRv6 locator route that left SR-MPLS unaffected, and matched three fictional requirements to the right architecture on their technical merits." },
];
